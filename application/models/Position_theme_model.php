...
class Position_theme_model extends CI_Model {
	public function __construct(){
        parent::__construct();
       // $ci &=get_instance();
        $this->load->database();
        $this->tbl='sr_position';
        $this->prefix='position_';
    }
...
/* End of file Position_theme_model.php */
/* Location: ./application/models/Position_theme_model.php */