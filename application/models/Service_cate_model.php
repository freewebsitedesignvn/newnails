...
class Service_cate_model extends CI_Model {
	public function __construct(){
        parent::__construct();
       // $ci &=get_instance();
        $this->load->database();
        $this->tbl='sr_cate_service';
    }
	...
	function getOne_byid($aId)//---------------OK
	{
		...
		// ->join('sr_danhmuc_article', 'sr_danhmuc_article.dma_id = sr_article.dma_id');
		if (is_array($aId))
			$this->db->where_in($this->tbl.'.cate_id', $aId);
		else			
			$this->db->where_in($this->tbl.'.cate_id', $aId);
...
/* End of file Service_cate_model.php */
/* Location: ./application/models/Service_cate_model.php */