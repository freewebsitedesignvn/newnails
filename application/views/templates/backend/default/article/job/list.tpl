...
{block name='Page_content'}
		...
		<div class="box">
		  ...
		  <div class="box-body">
		  	<p><a href="http://nails.tk/admin/job/job/add"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Add {$page_name} </button></a></p>
            ...
            <tr>
              ...
              <td>
              	<a href="http://nails.tk/admin/job/job/edit/{$item.a_id}"><span class="fa fa-pencil-square-o btn btn-primary"></span></a>
              	<a href="http://nails.tk/admin/job/job/delete/{$item.a_id}"><span class="fa fa-trash btn btn-danger"></span>	</a>
            	</td>
            </tr>
            {/foreach}
	        </tbody>
