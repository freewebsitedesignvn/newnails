				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="" placeholder="Title" required="required" name="title" value="{$set.a_title}">
						</div>
					</div>	
				</div>
...
/* Location: ./application/views/templates/backend/default/article/job/edit.tpl */ -->