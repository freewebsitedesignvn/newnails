		...
		<div class="box">
		  ...
		  <div class="box-body">
	        ...
	        <tbody>
	            ...
	            <tr>
	              <td><?= $set['position_name'] ?></td>
	              <td>
	              	<!-- <a href="<?= base_url($info['control']) ?>edit/<?= $key ?>" title="Edit"><span class="fa fa-pencil-square-o btn btn-primary"></span></a> -->
	              	<!-- <a href="<?= base_url($info['control']) ?>edit/<?php echo $set['position_id'] ?>"><span class="fa fa-pencil-square-o btn btn-primary"></span></a> -->
	              	<!-- <a href="<?= base_url($info['control']) ?>delete/<?= $key ?>" title="Delete"><span class="fa fa-trash btn btn-danger"></span>	</a> -->
	              	<a href="<?= base_url($info['control']) ?>delete/<?php echo $set['position_id'] ?>"  title="Delete"><span class="fa fa-trash btn btn-danger"></span>	</a>
	            	</td>
	            </tr>
	            <?php endforeach; ?>
            <?php else: ?>
...
<!-- /.content -->
	...
	/* Location: ./application/views/backend/default/discount/position/list.php */