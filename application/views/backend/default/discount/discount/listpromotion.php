		  			...
		  			<?php if (!empty($data)): ?>
		  				<?php foreach ($data as $key => $set): ?>
		  					 <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		  					 		<a href="../listpromotionedit/<?= $set['disc_id'] ?>"><button type="button" class="btn btn-primary btn-lg btn-block"><?= $set['disc_name'] ?></button></a>
		  					 		<!-- <a href="../listpromotionadd/<?= $set['disc_id'] ?>"><button type="button" class="btn btn-primary btn-lg btn-block"><?= $set['disc_name'] ?></button></a> -->
		  					 </div>
		  				<?php endforeach ?>
		  			<?php else: ?>
