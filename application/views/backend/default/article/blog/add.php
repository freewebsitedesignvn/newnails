...
<section class="content">
   <!-- <div class="callout callout-info">
	...
	<div class="box">
		...
		<div class="box-body">
			<form action="<?= base_url($info['control']) ?>add" method="POST" role="form">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="form-group">
							...
							<textarea name="content" id="editor" class="form-control" rows="5" placeholder="Content" style="" name="description"><?= set_value('content') ?></textarea>
	...
	/* End of file add.php */
	/* Location: ./application/views/backend/default/article/blog/add.php */