...
class Discouttype extends CI_Controller {
	function __construct()
	{
		...
		$this->viewPath='backend/default/discount/type/';
		$this->currentControl='admin/discount/discouttype/';
		$this->DirPhoto='upload/discount/';
