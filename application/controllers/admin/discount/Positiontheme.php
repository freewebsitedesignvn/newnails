...
class Positiontheme extends CI_Controller {
	function __construct()
	{
		parent::__construct();   
		$this->load->helper('string');
		// $this->load->library('upload');
		$this->load->model('Position_theme_model','position');
		// $this->load->model('Photo_cateser_model','photo');
		$this->load->library('Myhtml');

		$this->funcName="Position Theme";
		...
		$this->viewPath='backend/default/discount/position/';
		$this->currentControl='admin/discount/positiontheme/';
		// $this->DirPhoto='upload/service/';

	}
	public function index()
	{
		// echo "string";
		$list=$this->position->getList();
	...
	public function add()
	{
		...
		$datacate=$this->position->getList();
  ...
  //   );
		$this->load->library('form_validation');
	 	...
	 	$this->form_validation->set_rules('constant', 'Alias', 'trim|required');
	...
	{
		$dataout=$this->serv->getOne_byid($id);
...
/* End of file Positiontheme.php */
/* Location: ./application/controllers/admin/discount/Positiontheme.php */