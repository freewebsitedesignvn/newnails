...
(function ($) {
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class='ajax-file-upload-container container'></div>").insertAfter($(obj));
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.statusbar = $("<div class='ajax-file-upload-statusbar col-xs-6 col-sm-4 col-md-3 col-lg-3'></div>").css("width","auto");
			// this.statusbar = $("<div class='ajax-file-upload-statusbar col-lg-3'></div>").width(s.statusBarWidth);
            this.preview = $("<img class='ajax-file-upload-preview img-responsive' /> ").css("margin","0px auto").height(s.previewHeight).appendTo(this.statusbar).hide();
            // this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename text-center'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").width("70%").appendTo(this.statusbar).hide();
